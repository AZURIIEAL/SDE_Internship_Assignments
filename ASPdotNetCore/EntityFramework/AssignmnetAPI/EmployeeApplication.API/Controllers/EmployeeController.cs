...
public async Task<IActionResult> AddAsync([FromBody] EmployeeDuplicate emp)
{
try
{
...
[HttpPut("{id}")]
public async Task<IActionResult> UpdatebyIdAsync(int id,[FromBody] EmployeeDuplicate emp)
{
try
{
